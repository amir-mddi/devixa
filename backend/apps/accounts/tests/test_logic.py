...
from backend.apps.accounts.dtos.session_auth_dto import LoginUserDTO, RegisterUserDTO
from backend.apps.accounts.repositories.account_logic import AccountLogicRepository
from backend.apps.accounts.vo.auth_vo import AccountAuthErrorCodeVO
from backend.apps.accounts.vo.password_recovery_vo import AccountPasswordRecoveryErrorCodeVO
from backend.apps.accounts.vo.phone_verification_vo import AccountPhoneVerificationErrorCodeVO
...
class AccountLogicRepositoryTests(IsolatedServiceTestMixin, TestCase):
    ...
    @patch("backend.apps.accounts.repositories.account_logic.authenticate")
    ...
    @patch("backend.apps.accounts.repositories.account_logic.authenticate", return_value=None)
