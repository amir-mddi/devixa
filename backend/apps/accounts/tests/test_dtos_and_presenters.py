...
from backend.apps.accounts.dtos.password_recovery_dto import PasswordRecoveryResultDTO
from backend.apps.accounts.dtos.session_auth_dto import AuthResultDTO, LoginUserDTO
...
from backend.apps.accounts.web.presenters import (
    AccountWebAuthErrorPresenter,
    AccountWebPasswordRecoveryErrorPresenter,
)
from backend.apps.accounts.web.value_objects import AccountWebFieldNameVO, AccountWebValidationMessageVO
