...
from backend.apps.billing.models import Order, Payment, PaymentReceipt
...
from backend.apps.courses.models import Course, CourseReview
...
from backend.apps.telegram_bot.dtos.commerce_bot_dtos import (
    TelegramCheckoutDTO,
