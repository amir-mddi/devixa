...
from backend.apps.admin_panel.adapters import AdminBotClientFactory
from backend.apps.admin_panel.repositories import AdminPanelRepository
from backend.apps.billing.dtos import DiscountCreateDTO, PaymentReceiptReviewDTO
from backend.apps.billing.repositories.logic import BillingLogicRepository
from backend.apps.courses.dtos import ReviewModerationDTO
from backend.apps.courses.enums import ReviewStatusEnum
from backend.apps.courses.repositories.logic import CourseLogicRepository
from backend.apps.telegram_bot.repositories.logic.bot_notification_logic import (
