...
from backend.apps.billing.dtos import BasketAddItemDTO, BasketApplyDiscountDTO, CheckoutDTO
from backend.apps.billing.enums import (
    DiscountTypeEnum,
    OrderStatusEnum,
    PaymentStatusEnum,
)
from backend.apps.billing.logic import BasketLogic
from backend.apps.billing.repositories.logic import BillingLogicRepository
from backend.apps.billing.models import DiscountCode, Order, Payment, PaymentReceipt
from backend.apps.courses.models import CourseEnrollment
from backend.tests.factories import CourseFactory, ProjectConfigFactory, UserFactory
...
class BasketWebTests(TestCase):
    ...
    @patch.dict(
        os.environ,
        {
            ...
            "CARD_TO_CARD_ACCOUNT_OWNER": "Devixa Academy",
