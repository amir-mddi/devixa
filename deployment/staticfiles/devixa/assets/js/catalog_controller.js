(() => {
    ...
    class DevixaCatalogController {
        ...
        emitPageChange(total) {
            ...
            this.root.dispatchEvent(new CustomEvent('devixa:catalog:page-change', { detail }));
            this.onPageChange(detail);
        }
    }

    window.DevixaCatalogController = DevixaCatalogController;
})();
