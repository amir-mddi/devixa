...
from dealio.apps.billing.enums import PaymentStatusEnum
from dealio.apps.billing.repositories.adapters.payment_gateway_adapter import (
    PardakhtyarPaymentGatewayAdapter,
)
from dealio.apps.billing.serializers import PaymentReceiptSerializer
from dealio.tests.factories import PaymentFactory, PaymentReceiptFactory, UserFactory
...
class PardakhtyarGatewaySecurityTests(SimpleTestCase):
    ...
    @patch("dealio.apps.billing.repositories.adapters.payment_gateway_adapter.requests.post")
...
class PaymentCallbackSecurityTests(APITestCase):
    ...
    @patch("dealio.apps.billing.views.BillingLogicRepository.confirm_gateway_callback")
    ...
    def test_unsafe_frontend_redirect_is_ignored(self):
        ...
        from dealio.apps.billing.views import PaymentGatewayCallbackAPIView
