...
from dealio.apps.articles.adapters import ArticlePostgresAdapter
from dealio.apps.articles.dtos import (
    ArticleCatalogDTO,
    ArticleCatalogFilterDTO,
    ArticleCategoryFilterDTO,
    ArticleDetailDTO,
)
from dealio.apps.articles.entities import ArticleTypeFilterEntity
from dealio.apps.articles.enums import ArticleTypeEnum
from dealio.apps.articles.repositories import ArticleRepository
from dealio.apps.articles.value_objects import (
