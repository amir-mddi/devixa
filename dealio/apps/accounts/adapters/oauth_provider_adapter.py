...
from dealio.apps.accounts.dtos.oauth_dto import OAuthAuthorizationRequestDTO, OAuthCodeExchangeDTO
...
from dealio.apps.accounts.vo.oauth_vo import (
    OAuthDefaultVO,
    OAuthEndpointVO,
    OAuthLogMessageVO,
    OAuthMessageVO,
