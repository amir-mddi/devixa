...
from dealio.apps.courses.dtos.web_course_dtos import (
    CourseCatalogDTO,
    CourseCategoryFilterDTO,
    CourseDetailPageDTO,
)
from dealio.apps.courses.dtos.roadmap_dtos import CourseRoadmapCatalogDTO, CourseRoadmapDetailDTO
from dealio.apps.courses.entities.roadmap_entities import CourseRoadmapCatalogEntity
from dealio.apps.courses.enums import CourseLevelEnum
